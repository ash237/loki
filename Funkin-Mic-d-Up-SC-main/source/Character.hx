...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-loki':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/girlboss_assets','shared');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'bf':
				...
				flipX = true;
			case 'bf-loki':
				var tex = Paths.getSparrowAtlas('characters/ninjaFortnite','shared');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('worried', 'BF idle worried', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
			...
			case 'loki':
				frames = Paths.getSparrowAtlas('characters/Loki_Animations','shared');
				animation.addByPrefix('idle', 'Loki idle', 24, false);
				animation.addByPrefix('singUP', 'Loki Up', 24, false);
				animation.addByPrefix('singDOWN', 'Loki Down', 24, false);
				animation.addByPrefix('singLEFT', 'Loki Left', 24, false);
				animation.addByPrefix('singRIGHT', 'Loki Right', 24, false);
				animation.addByPrefix('jump', 'Loki Jump', 24, false);

				addOffset('idle');
				addOffset("singUP", 10, 47);
				addOffset("singRIGHT", -1, 39);
				addOffset("singLEFT", 65, 41);
				addOffset("singDOWN", 8, -11);
				addOffset("jump", 78, 643);
	...
	public function dance()
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'gf' | 'gf-christmas' | 'gf-car' | 'gf-pixel' | 'gf-loki':
				...
				case 'spooky':
					...
					if (danced)
						...
						playAnim('danceLeft');
				case 'loki':
					if (!animation.curAnim.name.startsWith('jump'))
					{
						playAnim('idle');
					}
				default:
